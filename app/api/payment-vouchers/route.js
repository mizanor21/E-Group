import { getTodayCreatedPaymentVouchersFromAllYears } from '@/app/lib/Accounts/fetchPaymentsVouchersToday';
import { getVoucherModelByYear } from '@/app/lib/Accounts/voucherModel';
import { connectToDB } from '@/app/lib/connectToDB';

export async function GET() {
  try {
    const data = await getTodayCreatedPaymentVouchersFromAllYears();
