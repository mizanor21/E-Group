...
const IncomeOverview = ({
  ...
  const downloadPDF = () => {
    ...
    // Add title
    doc.setFontSize(16)
    doc.text(`Income Overview - ${selectedYear}`, 14, 15)
    ...
    doc.save(`income-overview-${selectedYear}.pdf`)
  }

  return (
    (<div className="p-6 bg-white rounded-lg shadow-sm">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Income Balance Overview</h1>
