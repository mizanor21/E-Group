    ...
    return (
        <div className="bg-white p-10 space-y-10">
            ...
            <div className="mb-6">
                ...
                <div className="flex items-center gap-4  border rounded-xl p-5">
                    <input
                        type="number"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div>
                    ...
                    <div className="border rounded-lg p-5 shadow-sm">
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <input type="text" placeholder="Allowances" className={inputStyle} />
                            <input type="text" placeholder="Special Allowances" className={inputStyle} />
                            <input type="text" placeholder="Accommodation" className={inputStyle} />
                            <input type="text" placeholder="Food Allowance" className={inputStyle} />
                            <input type="text" placeholder="Telephone Allowance" className={inputStyle} />
                            <input type="text" placeholder="Transport Allowance" className={inputStyle} />
                        </div>
                        <button className={btnStyle}>Process</button>
                ...
                <div>
                    ...
                    <div className="border rounded-xl border-rose-500 p-5 shadow-sm">
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <input type="text" placeholder="Number of Leave" className={inputStyle} />
                            <input type="text" placeholder="Ded Leave" className={inputStyle} />
                            <input type="text" placeholder="Ded-Fines" className={inputStyle} />
                            <input type="text" placeholder="Ded-Doc" className={inputStyle} />
                            <input type="text" placeholder="Ded-Others" className={inputStyle} />
                            <button className={btnStyle}>Process</button>
                        </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="border rounded-lg p-5 shadow-sm">
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <input type="text" placeholder="Adv Recovery" className={inputStyle} />
                            <input type="text" placeholder="Arrear Payments" className={inputStyle} />
                            <input type="text" placeholder="Current Balance" className={inputStyle} />
                        </div>
                        <button className={btnStyle}>Process</button>
                        <h4 className="font-bold text-center mt-4">Other Earning</h4>
                        <input
                            type="text"
                            placeholder="Leave It Empty It will Auto Generate"
                            className={inputStyle}
